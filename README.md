...
G-AI Desktop is a lightweight, modern, and feature-rich Electron-based desktop client for **Google Gemini**, **Google Search (AI Mode)**, **DeepSeek**, **Kimi**, **Copilot**, **ChatGPT** and **Claude**. It preserves the full capabilities of the official web interfaces while delivering a more native, efficient, and visually polished desktop experience.

---

## ✨ Features

*   **💡 Full ChatGPT / Claude Support**: Built-in support for **ChatGPT / Claude** alongside **Google Gemini**, **Google Search (AI Mode)**, **DeepSeek**, **Kimi** and **Copilot**. Easily set it as your default landing page or switch between suppliers.
...
*   **⚡ Quick Launcher (Feature Highlight)**:
    ...
    *   **Direct AI Querying**: Type your question or prompt directly into the launcher and hit Enter to instantly dispatch it to **Google Gemini**, **Google Search (AI Mode)**, **DeepSeek**, **Kimi**, **Copilot**, **ChatGPT** or **Claude**.
*   **⚙️ Customizable On-Startup Behavior (Feature Highlight)**:
    ...
    *   **Default Landing Choice**: Choose whether the app launches into **Google Gemini**, **Google Search (AI Mode)**, **DeepSeek**, **Kimi**, **Copilot**, **ChatGPT** or **Claude** by default.
...
*   **🔎 Native Web Page Search (Feature Highlight)**:
    ...
    *   **Suppliers Agnostic**: Works perfectly across **Google Gemini**, **Google Search (AI Mode)**, **DeepSeek**, **Kimi**, **Copilot**, **ChatGPT** and **Claude** interfaces.
...
*   **💾 High-Fidelity Chat Export**:
    *   Export your active chat conversations from **Google Gemini** or **Google Search (AI Mode)** or **DeepSeek** or **Kimi** or **Copilot** or **ChatGPT** or **Claude** into **HTML**, **PDF** formats.
...
![G-AI Desktop cp_ql.jpg](https://raw.githubusercontent.com/shalahu/g-ai-desktop/refs/heads/main/assets/cp_ql.jpg)

![G-AI Desktop cg_ql.jpg](https://raw.githubusercontent.com/shalahu/g-ai-desktop/refs/heads/main/assets/cg_ql.jpg)

![G-AI Desktop cd_ql.jpg](https://raw.githubusercontent.com/shalahu/g-ai-desktop/refs/heads/main/assets/cd_ql.jpg)
...
*   **Content & Copyright**: 
    ...
    7.  This client merely provides a local multi-tab container to enhance your desktop productivity.
